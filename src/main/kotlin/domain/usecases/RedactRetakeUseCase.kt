...
class RedactRetakeUseCase(
    ...
    suspend operator fun invoke(id: Long, startAtIso: String, endAtIso: String, teacherIds: List<Long>, type: String, admission: String?): Retake {
        ...
        return adminRepository.updateRetake(id, startAt, endAt, normalizedTeacherIds, type.trim(), admission?.trim())
    }
}
